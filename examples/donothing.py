#!/usr/bin/env python3
""" Inspiration for this reository
Copied from https://blog.danslimmon.com/2019/07/15/do-nothing-scripting-the-key-to-gradual-automation/comment-page-1/#comments
Modified to be compatible with Python3
"""
import sys
